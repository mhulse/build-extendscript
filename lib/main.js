...
export function provideBuilder() {
	...
	return class ExtendScriptBuildProvider {
		...
		settings() {
			...
			let scriptPath = 'C:\Program Files\Adobe\Adobe Utilities\ExtendScript Toolkit\ExtendScript Toolkit.exe';
			...
			return [
				...
				},
				{
					...
					exec: scriptPath,
					args: [ '-cmd', '{FILE_ACTIVE}' ],
					cwd: '{FILE_ACTIVE_PATH}',
					sh: false,
					keymap: 'ctrl-alt-cmd-b',
					atomCommandName: 'extendscript:cmd',
					errorMatch: errorMatch
				}
			];
